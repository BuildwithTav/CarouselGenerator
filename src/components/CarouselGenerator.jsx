...
export default function App() {
  ...
  function buildTmplHTML(slide, idx, total, tmpl, opts) {
    ...
    function darkFadeCover(s){
      ...
      const sublineColor=secondary;
      const fitScript="<script>(function(){var h=document.getElementById('hl');if(!h)return;var zone=document.getElementById('tz');var maxW=zone.offsetWidth;var maxH=zone.offsetHeight;var fs=88;h.style.fontSize=fs+'px';function fits(){return zone.scrollHeight<=maxH;}document.fonts.ready.then(function(){while(fs>36&&!fits()){fs-=2;h.style.fontSize=fs+'px';}window.__TEXT_FIT_DONE__=true;}).catch(function(){window.__TEXT_FIT_DONE__=true;});})();<\/script>";
    ...
    if(tmpl==="dark-fade"){body=darkFadeCover(slide);}
      ...
      body="<div style='position:relative;width:"+W+"px;height:"+H+"px;background:#000;overflow:hidden;'>"+imgTag(slide)
        ...
        +"<div style='width:"+numLineW+"px;height:5px;background:"+EC+";'></div>"
        +"</div>"
      ...
      body="<div style='position:relative;width:"+W+"px;height:"+H+"px;background:#0a0a0a;overflow:hidden;'>"+imgTag(slide)
        ...
        +"<div style='width:"+numLineW2+"px;height:5px;background:"+EC2+";'></div>"
        +"</div>"
                  ...
                  <div style={{display:"flex",flexDirection:"column",gap:0}}>
                    ...
                    {tmplContentStyleTab==="style"&&<div style={{display:"flex",flexDirection:"column",gap:12}}>
                      ...
                      {!activeIsCtaSlide&&<div style={{background:A.surface,border:`1.5px solid ${A.border}`,borderRadius:10,padding:14,display:"flex",flexDirection:"column",gap:10}}>
                        {/* Headline/Accent colour - only when NO EFFECT */}
                        {tmplEffect==="none"&&<>
                        ...
                        {/* Subline / topic colour - always show */}
