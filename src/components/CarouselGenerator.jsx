...
export default function App() {
  ...
  useEffect(()=>{
    ...
    const _ctaL3Def={comment:"and I'll send it straight over to you",follow:"for more posts like this every day",save:"this post before you scroll past",share:"it could change their direction",like:"it helps me make more content like this"};
        ...
        {nav==="templates"&&(
          <div style={{animation:"fadeUp 0.3s ease",maxWidth:1100,margin:"0 auto",width:"100%",paddingBottom:60}}>
            ...
            {tmplSelected&&(()=>{
              ...
              const ctaLine3Defaults={comment:"and I'll send it straight over to you",follow:"for more posts like this every day",save:"this post before you scroll past",share:"it could change their direction",like:"it helps me make more content like this"};
