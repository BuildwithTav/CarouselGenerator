...
export default function App() {
  ...
  useEffect(()=>{
    ...
    const _ctaL3Def={comment:"and I'll DM it to you within 24 hours",follow:"New content drops daily. Don't miss it.",save:"You'll want to come back to this. Trust.",share:"One share could change someone's life.",like:"It tells me to keep making content like this."};
    const _ctaTopDef=isDarkFade?"Save this. Most people will scroll past and stay broke.":isListicle?"If this helped, you need to follow.":isCleanPro?"Want the full strategy behind this?":isStory?"If this resonated — there's more where that came from.":isSplit?"The world changed. Are you keeping up?":"If this hit different — follow for more.";
        ...
        {nav==="templates"&&(
          <div style={{animation:"fadeUp 0.3s ease",maxWidth:1100,margin:"0 auto",width:"100%",paddingBottom:60}}>
                ...
                {[
                  ...
                  <div key={t.id} style={{position:"relative"}}>
                    <div onClick={()=>{
                      ...
                      if(!restored){
                        const PLACEHOLDER_IMGS={"dark-fade":"https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=1080&q=80","listicle":"https://source.unsplash.com/1080x1350/?sixpack,abs,shredded,bodybuilder","clean-pro":"https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1080&q=80","storytelling":null,"raw":"https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=1080&q=80","split-left":"https://source.unsplash.com/540x1350/?london,telephone,box,red,street","split-right":"https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=540&q=80"};
                        ...
                        if(t.id==="listicle"){setTmplEffect("fire");setTmplFont("bebasneue");setTmplBg("dark");setTmplPrimary("#FF6600");setTmplSecondary("#ffffff");setTmplAccentLineColor("#FF6600");setTmplFontSize(72);setTmplListicleNum(8);setTmplCtaType("follow");setTmplCtaTopLine("");setTmplCtaLine2("");setTmplCtaKeyword("");setTmplCtaRewardLine("");}
                        else if(t.id==="dark-fade"){setTmplEffect("chrome");setTmplFont("bebasneue");setTmplBg("dark");setTmplPrimary("#C9A84C");setTmplSecondary("#ffffff");setTmplAccentLineColor("#C9A84C");setTmplFontSize(72);setTmplCtaType("save");setTmplCtaTopLine("");setTmplCtaLine2("");setTmplCtaKeyword("");setTmplCtaRewardLine("");}
                        ...
                        else if(t.id==="split"){setTmplEffect("chrome");setTmplFont("bebasneue");setTmplBg("dark");setTmplPrimary("#ffffff");setTmplSecondary("#ffffff");setTmplAccentLineColor("#C9A84C");setTmplFontSize(72);setTmplCtaType("save");setTmplCtaTopLine("");setTmplCtaLine2("");setTmplCtaKeyword("");setTmplCtaRewardLine("");}
                      }
            ...
            {tmplSelected&&(()=>{
              ...
              const ctaLine3Defaults={comment:"and I'll DM it to you within 24 hours",follow:"New content drops daily. Don't miss it.",save:"You'll want to come back to this. Trust.",share:"One share could change someone's life.",like:"It tells me to keep making content like this."};
              const ctaHTML=tmplShowCta?buildCtaHTML(opts,tmplCtaType,ctaKeywordDefaults[tmplCtaType],tmplCtaTopLine||(isDarkFade?"Save this. Most people will scroll past and stay broke.":_iife_isListicle?"If this helped, you need to follow.":isCleanPro?"Want the full strategy behind this?":isStory?"If this resonated — there's more where that came from.":isSplit?"The world changed. Are you keeping up?":"If this hit different — follow for more."),tmplCtaLine2||ctaLine2Defaults[tmplCtaType],tmplCtaRewardLine||ctaLine3Defaults[tmplCtaType],ctaBgFinal,name,handle,profileUrl,blueTick,isStory?tmplFontStyle:tmplFont,tmplSlideCount+(tmplShowCta?1:0),tmplShowCounter):null;
                    ...
                    {tmplContentStyleTab==="content"&&<div style={{display:"flex",flexDirection:"column",gap:12}}>
                      ...
                      <div style={{background:A.surface,border:`1.5px solid ${tmplShowCta?GOLD:A.border}`,borderRadius:10,overflow:"hidden"}}>
                        ...
                        {tmplShowCta&&<div style={{padding:"0 14px 14px",display:"flex",flexDirection:"column",gap:10}}>
                          ...
                          <input value={tmplCtaTopLine} onChange={e=>setTmplCtaTopLine(e.target.value)} placeholder={isDarkFade?{comment:"Drop a word below if this opened your eyes.",follow:"If this hit different — follow for more.",save:"Save this. Most people scroll past and stay broke.",share:"Share this with someone still sleeping on it.",like:"Like this if it made you think."}[tmplCtaType]||"What did this make you think?":isListicle?{comment:"Drop a word below for your free fat loss guide.",follow:"If this helped, you need to follow.",save:"Save this workout — you'll want it later.",share:"Share this with someone who needs to move.",like:"Like this if you felt it."}[tmplCtaType]||"Want more content like this?":isCleanPro?{comment:"Drop a word below for the full strategy.",follow:"Follow if you want to grow faster online.",save:"Save this — it's worth revisiting.",share:"Share this with someone building online.",like:"Like this if it changed how you think."}[tmplCtaType]||"Want the full strategy?":isStory?{comment:"Drop a word if this resonated with you.",follow:"Follow for more stories like this.",save:"Save this — come back when you need it.",share:"Share this with someone who needs to hear it.",like:"Like this if it hit home."}[tmplCtaType]||"If this resonated — follow for more.":isSplit?{comment:"Drop a word if the world surprised you.",follow:"Follow to stay ahead of what's changing.",save:"Save this — the world's still changing.",share:"Share this with someone stuck in 2000.",like:"Like this if it made you think."}[tmplCtaType]||"The world changed. Are you keeping up?":{comment:"Drop a word below.",follow:"Follow if this helped.",save:"Save this for later.",share:"Share this with someone.",like:"Like this if it helped."}[tmplCtaType]||"Want more like this?"} style={{...inp}}/>
                          ...
                          <input value={tmplCtaRewardLine} onChange={e=>setTmplCtaRewardLine(e.target.value)} placeholder={tmplCtaType==="comment"?"and I'll DM it to you within 24 hours.":tmplCtaType==="follow"?"New content drops every day. Don't miss it.":tmplCtaType==="save"?"You'll want to come back to this.":tmplCtaType==="share"?"One share could change someone's direction.":"It tells me to keep making content like this."} style={{...inp}}/>
