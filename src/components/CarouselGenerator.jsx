                ...
                {[
                  ...
                  <div key={t.id} style={{position:"relative"}}>
                    <div onClick={()=>{
                      ...
                      if(!restored){
                        const PLACEHOLDER_IMGS={"dark-fade":"https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=1080&q=80","listicle":"https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1080&q=80","clean-pro":"https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1080&q=80","storytelling":null,"raw":"https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=1080&q=80","split-left":"https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=540&q=80","split-right":"https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=540&q=80"};
                    ...
                    {tmplContentStyleTab==="content"&&<div style={{display:"flex",flexDirection:"column",gap:12}}>
                      ...
                      <div style={{background:A.surface,border:`1.5px solid ${tmplShowCta?GOLD:A.border}`,borderRadius:10,overflow:"hidden"}}>
                        ...
                        {tmplShowCta&&<div style={{padding:"0 14px 14px",display:"flex",flexDirection:"column",gap:10}}>
                          ...
                          <input value={tmplCtaTopLine} onChange={e=>setTmplCtaTopLine(e.target.value)} placeholder={isDarkFade?"Save this. Most people will scroll past and stay broke.":isListicle?"If this helped, you need to follow.":isCleanPro?"Want the full strategy behind this?":isStory?"If this resonated — there's more where that came from.":isSplit?"The world changed. Are you keeping up?":"If this hit different — follow for more."} style={{...inp}}/>
                          ...
                          <input value={tmplCtaRewardLine} onChange={e=>setTmplCtaRewardLine(e.target.value)} placeholder={tmplCtaType==="comment"?"and I'll DM it to you within 24 hours":tmplCtaType==="follow"?"New content drops daily. Don't miss it.":tmplCtaType==="save"?"You'll want to come back to this. Trust.":tmplCtaType==="share"?"One share could change someone's life.":"It tells me to keep making content like this."} style={{...inp}}/>
