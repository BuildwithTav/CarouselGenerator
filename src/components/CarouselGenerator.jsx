                  ...
                  <div key={t.id} style={{position:"relative"}}>
                    <div onClick={()=>{
                      ...
                      if(!restored){
                        ...
                        setTmplSlides(defaults);setTmplSlideCount(t.id==="listicle"?7:6);setTmplBrief("");setTmplFontSize({"dark-fade":72,"listicle":82,"clean-pro":64,"storytelling":48,"raw":56,"split":56}[t.id]||72);
                      }
