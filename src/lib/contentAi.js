...
The prompt must read like a professional photographer's shot brief: subject and pose, setting, lighting (golden hour, softbox, window light...), lens and depth of field, colour palette, mood, skin and surface detail. 60-110 words. Never include text, logos, watermarks or captions in the image. Keep it tasteful and non-explicit. If the brand is about feet, insist on anatomically perfect feet: five toes, natural proportions, smooth skin, neat pedicure, correct arches — and name the exact framing (soles up, toes pointed, arch curve, heels together).`;
  const user = `${brandContext(brand)}
Post idea: ${idea || "(none)"}
