      ...
      <div style={{maxWidth:720,margin:"0 auto"}}>
        ...
        {[
          ...
          },
          {
            ...
            body: "Carousel Studio offers a free tier and paid subscription plans (Starter, Pro, and Agency). One-time licence options (Affiliate Licence and White Label Licence) are also available. Credits are allocated monthly and do not roll over to the following month. Each plan includes a monthly credit allowance: Free (60 credits), Starter (200 credits), Pro (800 credits), Agency (3,000 credits). Credits are consumed per action: carousel generation costs 10 credits, quote card batch costs 10 credits, AI caption costs 5 credits, AI rewrite costs 5 credits, and downloading a carousel costs 5 credits. Photo uploads are free.\n\nPayments are processed securely via Stripe. Monthly subscriptions renew automatically each month unless cancelled. You may cancel at any time — your access continues until the end of your current billing period.\n\nOne-time licence purchases are non-refundable after 30 days. Within 30 days of purchase, refund requests will be considered at our sole discretion.\n\nRefunds are not provided for partial months of subscription except at our sole discretion."
          },
          {
